    ...
    return Scaffold(
      ...
      body: Obx(() => CustomScrollView(
            slivers: [
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Expanded(
                                    child: Text(
                                  _homeworkController.data['name'].toString(),
                            ...
                            Card(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color: Color.fromARGB(255, 109, 185, 255),
                                    borderRadius:
                            ...
                            Card(
                              child: Column(
                                children: _homeworkController.homeworkDocResList
                                    .map((e) => ListTile(
                                          leading: Image.asset(
                                            extToIcons(e['type']),
                                            height: 26,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_homeworkController.data['submitStatus'] ==
                                  0) ...[
                                TextField(
              ...
              // SliverToBoxAdapter(
              //   child: Text(_homeworkController.data.toString()),
              // )
            ],
          )),
    );
